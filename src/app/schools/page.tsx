  ...
  return (
    <div style={{ position: "relative", overflow: "hidden" }}>
      ...
      <section style={{ padding: "64px 40px", background: "#fff", borderTop: "1px solid var(--line)", borderBottom: "1px solid var(--line)" }}>
        <div className="container reveal" style={{ maxWidth: 1000, display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 40 }}>
          <div>
            <div className="eyebrow" style={{ color: "var(--red)", marginBottom: 12 }}>O problema real</div>
            <p style={{ margin: 0, fontSize: 15.5, lineHeight: 1.65 }}>Sua escola sabe que precisa avançar em internacionalização, mas falta clareza sobre currículo, formação de professores, liderança e avaliação. Fazer isso sem método arrisca descaracterizar a identidade da instituição.</p>
          </div>
          <div>
            <div className="eyebrow" style={{ color: "var(--blue)", marginBottom: 12 }}>O que a Promise resolve</div>
            <p style={{ margin: 0, fontSize: 15.5, lineHeight: 1.65 }}>Um caminho estruturado, com metodologia, acompanhamento e objetivos claros, não uma proposta genérica. O diagnóstico inicial já mostra se e como o investimento faz sentido para a sua realidade, antes de qualquer compromisso.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: 26 }}>
            <div className="reveal reveal-delay-1" style={{ background: "#fff", border: "1px solid var(--line)", borderRadius: 14, padding: 28 }}>
              ...
              <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.6, color: "var(--ink-soft)" }}>Conversa direta com o fundador para entender o momento da escola antes de qualquer proposta.</p>
            </div>
            <div className="reveal reveal-delay-2" style={{ position: "relative", borderRadius: 14, overflow: "hidden", height: 220 }}>
              ...
              <div style={{ position: "relative", zIndex: 1, height: "100%", padding: 24, display: "flex", flexDirection: "column", justifyContent: "flex-end", color: "#fff" }}>
                ...
                <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.6 }}>Currículo de inglês e internacionalização adaptado à identidade e ao momento da instituição.</p>
              </div>
            </div>
            <div className="reveal reveal-delay-3" style={{ background: "#fff", border: "1px solid var(--line)", borderRadius: 14, padding: 28 }}>
              ...
              <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.6, color: "var(--ink-soft)" }}>Capacitação contínua da equipe docente e de coordenação, não um treinamento único e isolado.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "var(--blue)", padding: "0", position: "relative", overflow: "hidden" }}>
        <div className="container reveal" style={{ padding: 0, display: "grid", gridTemplateColumns: "1fr 1.3fr", alignItems: "center" }}>
