...
export default function GlobalPage() {
  return (
    <div style={{ position: "relative", overflow: "hidden" }}>
      ...
      <section className="section-pad" style={{ padding: "70px 40px", background: "#fff", borderTop: "1px solid var(--line)", borderBottom: "1px solid var(--line)" }}>
      ...
      <section className="section-pad" style={{ padding: "70px 40px", background: "var(--blue-dark)" }}>
      ...
      <section className="section-pad" id="matricula" style={{ padding: "76px 40px", background: "var(--tint)" }}>
