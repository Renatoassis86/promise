...
const FIELDS: Record<Tipo, { key: string; label: string; placeholder?: string; type?: FieldType; options?: string[]; full?: boolean; required?: boolean }[]> = {
  ...
  professionals: [
    ...
    { key: "cargo", label: "Cargo atual", type: "select", required: true, options: ["Professor", "Coordenador", "Líder", "Gestor", "Outro"] },
    { key: "email", label: "E-mail", placeholder: "voce@email.com", required: true },
    { key: "whatsapp", label: "WhatsApp", placeholder: "(00) 00000-0000", required: true },
    { key: "tempo_experiencia", label: "Experiência", type: "select", options: ["Estou começando", "1–3 anos", "4–7 anos", "8–14 anos", "15+ anos"] },
    {
      key: "objetivo",
      label: "Meu objetivo",
      type: "select",
      full: true,
      required: true,
      options: ["Formação continuada", "Workshop", "Curso livre", "Mentoria", "Preparação TKT", "Preparação CELTA", "Preparação DELTA", "Formação para coordenadores", "Desenvolvimento de liderança", "Consultoria", "Desenvolvimento institucional", "Ainda não sei"],
    },
